...
<html lang="{{ str_replace('_', '-', app()->getLocale()) }}">
    ...
    <body>
        ...
        <div class="container-fluid">
            ...
            <div class="col-md-4 col-sm-6 col-xs-12">
                                ...
                                <table>
                                    <tr>
                                        <td style="padding-right:3px">
                                            <span class="info-box-text">                                                    
                                                <span class="info-box-number">
                                                    1° Museos - 136.5 - 77.32%
													<div>2° Innovativa - 14.55 - 8.24%</div>
                                                </span>                                        
                                            </span>
                                        </td>
                                    </tr>
                        ...
                        <div class="info-box-content">
                            <span class="info-box-text">Hora Retrabajo Backlog 04
                                ...
                                <table>
                                    <tr>
                                        <td style="padding-right:3px">
                                            <span class="info-box-number text-red"> 12 Horas</span>
											<div>Acumulado 2020: 29</div>
                                        </td>
                                    </tr>
                                </table>
				...
				<div class="col-md-4 col-sm-6 col-xs-12">
                    <div class="info-box">
                        ...
                        <div class="info-box-content">
                            <span class="info-box-text">    
                                Siguiente Mejora ERP
                                <span class="info-box-number">
                                    Envío Nomina ERP<small> Baklog 06</small>
									<div>
										<small>Sustituiremos la ETL actual.</small>
									</div>
									<div>
										<small>Documentacion ágil.</small>
									</div>
                                </span>                                        
                            </span> 
                        </div>
                ...
                <div class="col-md-4 col-sm-6 col-xs-12">
                    <div class="info-box">
                        ...
                        <div class="info-box-content">
                                <span class="info-box-text">    
                                    Progreso Depuracion Metodología
                                    <span class="info-box-number">
                                        60<small>%</small>
                                    </span>                                        
                                </span> 
                ...
                <div class="col-md-4 col-sm-6 col-xs-12">
                    <div class="info-box">
                        ...
                        <div class="info-box-content">
                            <span class="info-box-text">Satisfacción del Cliente

                                <!-- /.info-box-content -->
                                <table>
                                    <tr>
                                        <td style="padding-right:3px">
                                            <!-- <span class="info-box-number text-red"><i class="fa fa-caret-down"></i> {{ round( 5.32, 2)}}% </span> -->
											<span class="info-box-number text-red"><i class="fa fa-caret-down"></i> No Definido </span>
            ...
            {{-- Promedio Global Consultores Sidesoft --}}
            <div class="row" style="padding-top: 10px; padding-bottom: 10px;">
                <div class="col">
				
					<div class="alert alert-warning" role="alert">
                        <h1>Promedio Global Consultores  <strong>{{round($promedioGlobal,2)}} <strong></h1>
                    </div>                           
            ...
            {{-- Historico Backlogs Consultores Sidesoft --}}
            <div class="row" style="padding-top: 30px; padding-bottom: 30px;">
                <div class="col">
                    {{-- <h1 class="text-center" style="padding-top: 30px; padding-bottom: 30px;">
                        Historico Calificación Consultores Sidesoft
                    </h1> --}}

                    <nav aria-label="breadcrumb">
                        <ol class="breadcrumb">
                            <li class="breadcrumb-item active" aria-current="page">Historico Backlogs Consultores Sidesoft</li>
                        </ol>
                    </nav>                    
    ...
    @endfor   
            ...
            <div class="row" style="padding-top: 30px; padding-bottom: 30px;">
                <div class="col">
                    ...
                    <nav aria-label="breadcrumb">
                        <ol class="breadcrumb">
                            <li class="breadcrumb-item active" aria-current="page">Historico Calificación Consultores Sidesoft</li>
                        </ol>
                    </nav>                    
